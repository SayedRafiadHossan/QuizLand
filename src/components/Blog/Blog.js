        ...
        >
          <div className="p-5 font-light border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
            <p className="mb-2 text-gray-500 dark:text-gray-400">
              ...
              user initiates an API call that tells the application to do
              something, then the application will use an API to ask the web
              server to do something. The API is the middleman between the
              application and the web server, and the API call is the request
            </p>
          </div>
        </div>
        ...
        <h2 id="accordion-open-heading-1">
          ...
          >
            <span className="flex items-center">
              ...
              what is useref hook and how does it works?
            </span>
            <svg
              data-accordion-icon=""
              className="w-6 h-6 rotate-180 shrink-0"
