...
const Home = () => {
    return (
        <nav>
            <div>
                <h1 className='font-extrabold text-6xl text-center font-serif mt-20'>Its Matter<span className='text-purple-500 ml-2'>how you ask</span></h1>
                <p className='text-center mt-2 text-lg'>Assessment, instruction, and practice that motivate every student to mastery</p>
                <div className='text-center mt-2'>
                    <button type="button" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Sign up for free </button>
                    <button type="button" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Learn More</button>
                </div>
        ...
        <div className="w-[60%] mr-12 p-10 pt-20">
          ...
          Quickly find or create anything in your curriculum Prepare high-quality, interactive content in as little as two minutes.
          </p>
